...
let urlPage = mainConfig.server.urls.test + mainConfig.server.pages.coach.url
	...
	it('Тренеры', function() {
		...
		return (
			browser
				...
				.pause(2000)
				.assertView('enterModal', query.coach.enterModal, mainConfig.tolerance)
				...
				.pause(1000)
				.assertView('formInvalidation', query.coach.form, mainConfig.tolerance)
